...
2. Copy the output. It will look something like this:  
    `/home/USER_NAME/PATH_TO_TALL_GRASS/tall_grass`
3. Add the following alias to your .bashrc or equivalent profile:  
    `# 'installing' tall_grass`  
    `alias tall_grass='cd /home/USER_NAME/PATH_TO_TALL_GRASS/tall_grass && ruby run.rb && cd - >> /dev/null'`  
...
* When you decide to have another encounter you will be prompted with "Would you like a new location?" where return keep you in the area that you last specified and y takes you back to the original prompt.
...
* You will be prompted with "Lookup by species name or number?" where you can enter 's', 'name', 'species', '#', 'num', or 'number'
